...
|------|-------------|------|---------|:--------:|
| <a name="input_app_projects"></a> [app\_projects](#input\_app\_projects) | List of ArgoCD AppProjects to create | <pre>list(object({<br/>    name        = string<br/>    description = optional(string, "")<br/>    extra_destinations = optional(list(object({<br/>      name      = optional(string)<br/>      server    = optional(string)<br/>      namespace = optional(string, "*")<br/>    })), [])<br/>  }))</pre> | `[]` | no |
